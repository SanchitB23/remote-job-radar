...
- [ ] Security concerns addressed (explain below)

<!-- Explain any security implications or considerations -->
...
<!-- Technical debt, future improvements, known limitations, etc. -->
...
- [ ] UX/UI changes are intuitive and accessible
- [ ] Ready to merge
