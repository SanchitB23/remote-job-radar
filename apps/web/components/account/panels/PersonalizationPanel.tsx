...
function LoadingSkillsCard() {
  return (
    <div className="flex items-center justify-center min-h-[160px] bg-muted/50 rounded-lg">
...
function ErrorSkillsCard({
  ...
  return (
    <div className="flex items-center justify-center min-h-[160px] bg-destructive/10 rounded-lg">
      <div className="flex flex-col items-center gap-2 p-6">
...
export function PersonalizationPanel() {
  ...
  return (
    <Card className="rounded-lg border bg-background p-0 shadow-sm">
